function About() {
 return (
   <section className="flex flex-col w-full p-6 scroll-smooth" id="about">
     ...
     <div className="max-w-3xl mx-auto space-y-4 text-lg text-textGray">
       <p>
         Founded in 2012 and Established with a passion for the art of barbering
         and a commitment to our community. We envisioned a place where everyone
         could experience the timeless art of grooming in a comfortable and
       ...
       <p>
         ...
         haircut, a precision shaves, or a stylish beard trim, we are here to
         make it happen.
       </p>
       <p>
       ...
       <p>
         If you're looking for a top-notch grooming experience, we invite you to
         visit us. With our exceptional service and attention to detail, we're
         confident that you'll leave our shop feeling refreshed, relaxed, and
         confident.
       </p>
     </div>
   </section>
